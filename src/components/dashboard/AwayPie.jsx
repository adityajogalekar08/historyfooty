...
const AwayPieChart = (props) => {
	const result = getSummarizedStats(props.team);
	const data = [
		{ name: "Wins", value: result.awayGamesWon },
		{ name: "Loses", value: result.awayGamesLost },
		{ name: "Draw", value: result.awayGamesDraw },
	];
